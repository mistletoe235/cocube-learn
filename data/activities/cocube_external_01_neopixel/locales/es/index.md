...
![Módulo de panel LED RGB NeoPixel](NeoPixel.png =180x*)
...
2. **Añadir biblioteca**: En la carpeta "Bibliotecas", añade la biblioteca "Módulo CoCube". Esta biblioteca incluye las tres funciones más usadas del panel NeoPixel: conectar, iluminar y apagar.
