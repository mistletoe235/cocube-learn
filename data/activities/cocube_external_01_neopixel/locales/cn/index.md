...
![NeoPixel 全彩灯板模块](NeoPixel.png =180x*)
![个人电脑 或 平板](PC.png =250x*)

### 3. 软件平台

[MicroBlocks——CoCube & CoCube Module](https://cocube.fun#scripts=GP%20Scripts%0Adepends%20%27CoCube%27%20%27CoCube%20Module%27)
...
2. **添加积木库：**&#x5728;“积木库”目录下，添加“CoCube 外接模块”——“CoCube 外接模块”中涵盖了 NeoPixel 灯板最常用的三种功能——连接、点亮以及关闭。

![](image-1.png)
![](image.png)

* **连接NeoPixels：**&#x5728;“CoCube 外接模块”积木库中找到“连接 NeoPixels”积木块，拖拽到工作区，并单击运行。
...
NeoPixel 全彩灯板采用 WS2812 芯片驱动，LED 灯珠按照从左到右，从上到下的次序排布，每个 LED 灯珠的颜色和亮度均能被独立控制。添加“CoCube 外接模块”库之后，可以看到该库所依赖的 NeoPixel 库也被同时加载进了 MicroBlocks IDE 中，基于它，我们可以实现更加丰富的效果。
