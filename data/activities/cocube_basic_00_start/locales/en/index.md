...
| dlight          | ![](dlight.png =200x*) | Digital ambient light detection sensor with characteristics of small size and low power consumption, suitable for various brightness detection and control adjustment scenarios. |
| ASR          | ![](ASR.png =200x*) | Speech recognition module with built-in 150 common command words, supporting self-learning wake words and command words. Suitable for voice dialogue, smart home control and other scenarios. |
